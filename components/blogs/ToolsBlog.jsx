export default function ToolsBlog({ data }) {
  return (
    <>
      ...
      <div className="blog-slide blog-content-slide">
        ...
        <h2>Token Integration</h2>
        <p>{data.challenge}</p>
      </div>

      <div className="blog-slide blog-content-slide">
        <div className="blog-slide-num">02</div>
        <h2>Auto-Layout Standard</h2>
        <p>{data.strategy1}</p>
      ...
      <div className="blog-slide blog-design-slide">
        ...
        <div className="blog-imgs-row">
          <div className="blog-img-card">
            ...
            <div className="blog-img-cap">Figma Component Mapping</div>
          </div>
          <div className="blog-img-card">
            <div className="blog-img-mock" style={{ backgroundImage: `url('${data.images[2]}')` }}></div>
            <div className="blog-img-cap">Interactive Code Compilation</div>
          </div>
        </div>
      </div>
