export default function ContactBlog({ data }) {
  return (
    <>
      ...
      <div className="blog-slide blog-content-slide">
        ...
        <h2>Solving Friction</h2>
        <p>{data.challenge}</p>
      </div>

      <div className="blog-slide blog-content-slide">
        <div className="blog-slide-num">02</div>
        <h2>Audits & Product Setup</h2>
        <p>{data.strategy1}</p>
      ...
      <div className="blog-slide blog-design-slide">
        ...
        <div className="blog-imgs-row">
          <div className="blog-img-card">
            ...
            <div className="blog-img-cap">Strategy Call Booking</div>
          </div>
          <div className="blog-img-card">
            <div className="blog-img-mock" style={{ backgroundImage: `url('${data.images[2]}')` }}></div>
            <div className="blog-img-cap">Creative Audit Prep</div>
          </div>
        </div>
      </div>
