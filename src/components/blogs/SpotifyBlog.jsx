export default function SpotifyBlog({ data }) {
  return (
    <>
      <div className="blog-slide blog-cover-slide">
        ...
        <div className="blog-cover-info">
          ...
          <div className="blog-meta-grid">
            {[
              ['Atmosphere', data.client],
              ['Curator', data.role],
              ['Active Mode', data.timeline],
              ['Top Genres', data.services]
            ].map(([l, v]) => (
      ...
      <div className="blog-slide blog-content-slide">
        ...
        <h2>Dampening Digital Fatigue</h2>
        <p>{data.challenge}</p>
      </div>

      <div className="blog-slide blog-content-slide">
        <div className="blog-slide-num">02</div>
        <h2>Rhythm & Interface</h2>
        <p>{data.strategy1}</p>
      ...
      <div className="blog-slide blog-design-slide">
        ...
        <div className="blog-imgs-row">
          <div className="blog-img-card">
            ...
            <div className="blog-img-cap">Ambient soundscapes for coding</div>
          </div>
          <div className="blog-img-card">
            <div className="blog-img-mock" style={{ backgroundImage: `url('${data.images[2]}')` }}></div>
            <div className="blog-img-cap">Focus beat frequencies</div>
          </div>
        </div>
      </div>
