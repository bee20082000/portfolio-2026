export default function ClientsBlog({ data }) {
  return (
    <>
      ...
      <div className="blog-slide blog-design-slide">
        ...
        <div className="blog-imgs-row">
          <div className="blog-img-card">
            ...
            <div className="blog-img-cap">Panasonic Smart Hub Screens</div>
          </div>
          <div className="blog-img-card">
            <div className="blog-img-mock" style={{ backgroundImage: `url('${data.images[2]}')` }}></div>
            <div className="blog-img-cap">Heineken WebGL Microsite</div>
          </div>
        </div>
      </div>
