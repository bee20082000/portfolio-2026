  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        {data.images[7] ? (
          <img src={data.images[7]} alt="Moe Packaging Mockup 6" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
        ) : (
      ...
      <div style={{
        ...
        {data.images[3] ? (
          <img src={data.images[3]} alt="Moe Packaging Mockup 3" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
        ) : (
      ...
      <div style={{
        ...
        {data.images[0] ? (
          <img src={data.images[0]} alt="Moe Packaging Cover" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
        ) : (
      ...
      <div style={{
        ...
        {data.images[2] ? (
          <img src={data.images[2]} alt="Moe Packaging Mockup 2" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
        ) : (
      ...
      <div style={{
        ...
        {data.images[1] ? (
          <img src={data.images[1]} alt="Moe Packaging Mockup 1" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
        ) : (
      ...
      <div style={{
        ...
        {data.images[4] ? (
          <img src={data.images[4]} alt="Moe Packaging Mockup 4" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
        ) : (
      ...
      <div style={{
        ...
        {data.images[5] ? (
          <img src={data.images[5]} alt="Moe Packaging Mockup 5" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
        ) : (
      ...
      <div style={{
        ...
        {data.images[6] ? (
          <img src={data.images[6]} alt="Moe Packaging Mockup 6" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
        ) : (
          <div style={{ width: '100%', minHeight: '360px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#5f6368', backgroundColor: '#1c1d22' }}>Mockup 6 Placeholder</div>
        )}
      </div>
      ...
      <div style={{
        ...
        {data.images[8] ? (
          <img src={data.images[8]} alt="Moe Packaging Mockup 3" style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
        ) : (
          <div style={{ width: '100%', minHeight: '400px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#5f6368', backgroundColor: '#1c1d22' }}>Mockup 3 Placeholder</div>
        )}
      </div>
