...
import styles from './SkillsTile.module.css'

const TILE_BG_COLOR = ""; // Example: "#ff0000"
const TILE_TEXT_COLOR = ""; // Example: "#ffffff"
...
export default function SkillsTile({ onSelect }) {
  ...
  const getBadgeClass = () => {
    ...
    return `${styles[`skills-btn-warning-${clickCount}`]} ${clickCount === 2 ? styles['shake-active'] : ''}`
  }

  return (
    <div className="tile tile-skills c2" id="skills" data-i="5" onClick={handleClick} style={{ backgroundColor: TILE_BG_COLOR, color: TILE_TEXT_COLOR, "--text": TILE_TEXT_COLOR, "--text2": TILE_TEXT_COLOR, "--text3": TILE_TEXT_COLOR }}>
      <div className="inner">
